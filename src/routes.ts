...
import { ExampleDisplayPagesComponent } from './app/example/router/example-display-pages/example-display-pages.component';
...
export const routes: Routes = [
  ...
  { path: 'example', component: ExampleComponent, children: [
    ...
    {path: 'display', component: ExampleDisplayPagesComponent},
